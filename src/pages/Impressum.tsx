        ...
        <div className="space-y-6">
          <section className="space-y-4">
            ...
            <div className="text-muted-foreground leading-relaxed">
              <p className="font-semibold text-foreground">FRIK MAXEINER Rechtsanwälte PartG mbB</p>
              <p>Löffelstr. 22-24</p>
              <p>70597 Stuttgart</p>
            </div>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="text-muted-foreground leading-relaxed space-y-2">
              ...
              <p>Zuständige Kammer: Amtsgericht Stuttgart</p>
              <p>Registernummer: PR 721285</p>
