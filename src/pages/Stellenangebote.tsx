          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            <Card className="h-full">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-sm sm:text-base">Vollzeit | Unbefristet | Stuttgart</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="h-full">
              <CardHeader className="pb-3">
                ...
                <CardDescription className="text-sm sm:text-base">3-6 Monate | Befristet | Stuttgart</CardDescription>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 mb-4 text-sm sm:text-base leading-relaxed">
