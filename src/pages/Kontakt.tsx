            ...
            <div className="bg-gray-100 p-12">
              <div className="sticky top-8">
                ...
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">FRIK MAXEINER Rechtsanwälte</h4>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">(089) 277805030</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">(089) 277805031</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-sm">info@frik-maxeiner.de</p>
                    </div>
                  </div>
