...
const Team = () => {
  ...
  const teamMembers = [
    {
      id: 1,
      name: "Julian Maxeiner",
      email: "j.maxeiner@frik-maxeiner.de",
    ...
    },
    {
      id: 3,
      name: "Anna Weber",
      email: "verwaltung@frik-maxeiner.de",
          ...
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-2xl p-8 lg:p-12 text-center text-white">
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                ...
                einer der innovativsten Kanzleien Stuttgarts aktiv mit.
              </p>
